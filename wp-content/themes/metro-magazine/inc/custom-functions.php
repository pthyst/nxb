        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'metro-magazine' ), $name ) ; ?></p>
...
if( ! function_exists( 'metro_magazine_restore_admin_notice' ) ) :
/**
 * Restoring admin notice on theme switch
 */
function metro_magazine_restore_admin_notice(){
    update_option( 'metro_magazine_admin_notice', false );
}
endif;
add_action( 'after_switch_theme', 'metro_magazine_restore_admin_notice' );
