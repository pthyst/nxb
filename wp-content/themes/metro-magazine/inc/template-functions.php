  ...
  if ( is_front_page() ) {
    ...
    if( is_home() ){
        ...
        $request_uri = $_SERVER['REQUEST_URI'];
            echo $before .'<a itemprop="item" href="'. esc_url( $request_uri ) .'"><span itemprop="name">'. esc_html__( 'Search Results for "', 'metro-magazine' ) . esc_html( get_search_query() ) . esc_html__( '"', 'metro-magazine' ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
 
    } elseif ( is_day() ) {
        $depth = 2;
        echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'metro-magazine' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'Y', 'metro-magazine' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" /><span class="separator">' . esc_html( $delimiter ) . '</span></span>';
        $depth ++;
        echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'metro-magazine' ) ), get_the_time( __( 'm', 'metro-magazine' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'F', 'metro-magazine' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" /><span class="separator">' . esc_html( $delimiter ) . '</span></span>';
        $depth ++;
        echo $before .'<a itemprop="item" href="' . esc_url( get_day_link( get_the_time( __( 'Y', 'metro-magazine' ) ), get_the_time( __( 'm', 'metro-magazine' ) ), get_the_time( __( 'd', 'metro-magazine' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'd', 'metro-magazine' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
 
    } elseif ( is_month() ) {
        $depth = 2;
        echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'metro-magazine' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'Y', 'metro-magazine' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" /><span class="separator">' . esc_html( $delimiter ) . '</span></span>';
        $depth++;
        echo $before .'<a itemprop="item" href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'metro-magazine' ) ), get_the_time( __( 'm', 'metro-magazine' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'F', 'metro-magazine' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
 
    } elseif ( is_year() ) {
        $depth = 2;
        echo $before .'<a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'metro-magazine' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'Y', 'metro-magazine' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
        ...
        if( get_query_var('paged') ){
            ...
            echo ' <span class="separator">' . esc_html( $delimiter ) . '</span></span> ' . $before . sprintf( __('Page %s', 'metro-magazine'), get_query_var('paged') ) . $after;
        }elseif( is_archive() ){
